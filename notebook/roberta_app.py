...
model_path = "Henok21/my-fine-tuned-model"
...
demo = gr.Interface(
    ...
    description = "Comment your thought about on the vaccination to covid19. The work is done by fine tunning roberta base model."
    )
